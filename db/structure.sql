...
--
-- Name: index_job_runs_on_name_and_finished_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_job_runs_on_name_and_finished_at ON public.job_runs USING btree (name, finished_at);
...
--
-- Name: job_runs job_runs_protect; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER job_runs_protect BEFORE DELETE OR UPDATE ON public.job_runs FOR EACH ROW EXECUTE FUNCTION public.comeals_protect_job_run();
