...
**Phase 2 — Data model:** 5. Create migrations 6. Run migrations 7. Create models with validations/associations 8. Create factories 9. Write model specs

**Phase 3 — Integration:** 10. Add associations to Reconciliation and Resident 11. Implement `generate_settlement_plan!` 12. Add to rake task 13. Write integration test
