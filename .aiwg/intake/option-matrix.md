...
Longer-term: 4. Whether to pursue the collection workflow improvements (in-app Venmo/Zelle tracking) or keep collection out-of-app 5. Whether `resident_balances` refresh cadence (daily) is sufficient or should be more frequent
