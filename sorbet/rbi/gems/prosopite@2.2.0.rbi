...
# pkg:gem/prosopite#lib/prosopite/middleware/rack.rb:2
module Prosopite::Middleware; end

# pkg:gem/prosopite#lib/prosopite/middleware/rack.rb:3
class Prosopite::Middleware::Rack
  # pkg:gem/prosopite#lib/prosopite/middleware/rack.rb:4
  def initialize(app); end

  # pkg:gem/prosopite#lib/prosopite/middleware/rack.rb:8
  def call(env); end
end
