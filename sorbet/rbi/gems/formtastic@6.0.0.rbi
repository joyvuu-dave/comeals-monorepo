...
# pkg:gem/formtastic#lib/formtastic.rb:3
module Formtastic
...
#
# pkg:gem/formtastic#lib/formtastic/action_class_finder.rb:8
class Formtastic::ActionClassFinder < ::Formtastic::NamespacedClassFinder
  # @param builder [FormBuilder]
  #
  # pkg:gem/formtastic#lib/formtastic/action_class_finder.rb:11
  def initialize(builder); end

  # pkg:gem/formtastic#lib/formtastic/action_class_finder.rb:15
  def class_name(as); end
end

# pkg:gem/formtastic#lib/formtastic/actions.rb:3
module Formtastic::Actions
  extend ::ActiveSupport::Autoload
end

# pkg:gem/formtastic#lib/formtastic/actions/base.rb:4
module Formtastic::Actions::Base
  include ::Formtastic::LocalizedString

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:9
  def initialize(builder, template, object, object_name, method, options); end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:103
  def accesskey; end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:7
  def builder; end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:7
  def builder=(_arg0); end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:87
  def button_html; end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:91
  def button_html_from_options; end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:99
  def default_button_html; end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:50
  def default_wrapper_classes; end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:39
  def default_wrapper_html_options; end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:72
  def default_wrapper_id; end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:95
  ...
  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:76
  ...
  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:80
  def text; end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:20
  def to_html; end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:24
  def wrapper(&block); end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:46
  def wrapper_class; end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:54
  def wrapper_classes_from_options; end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:31
  def wrapper_html_options; end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:35
  def wrapper_html_options_from_options; end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:64
  def wrapper_id; end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:68
  def wrapper_id_from_options; end

  protected

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:114
  def check_supported_methods!; end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:118
  def i18n_key; end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:131
  def new_or_persisted_object?; end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:135
  def sanitized_object_name; end

  # pkg:gem/formtastic#lib/formtastic/actions/base.rb:123
...
#
# pkg:gem/formtastic#lib/formtastic/actions/button_action.rb:46
class Formtastic::Actions::ButtonAction
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/actions/button_action.rb:61
  def to_html; end
end

# pkg:gem/formtastic#lib/formtastic/actions/buttonish.rb:4
module Formtastic::Actions::Buttonish
  # pkg:gem/formtastic#lib/formtastic/actions/buttonish.rb:10
  def extra_button_html_options; end

  # pkg:gem/formtastic#lib/formtastic/actions/buttonish.rb:6
  def supported_methods; end
end
...
# @todo document i18n translation with :label (?)
#
# pkg:gem/formtastic#lib/formtastic/actions/input_action.rb:49
class Formtastic::Actions::InputAction
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/actions/input_action.rb:64
  def to_html; end
end
...
#
# pkg:gem/formtastic#lib/formtastic/actions/link_action.rb:57
class Formtastic::Actions::LinkAction
  ...
  #   Override or add to the HTML attributes to be passed down to the wrapping `<li>` tag
  #
  # pkg:gem/formtastic#lib/formtastic/actions/link_action.rb:71
  def supported_methods; end

  # TODO reset_action class?
  #
  # pkg:gem/formtastic#lib/formtastic/actions/link_action.rb:76
  def to_html; end

  # pkg:gem/formtastic#lib/formtastic/actions/link_action.rb:82
  def url; end
end

# pkg:gem/formtastic#lib/formtastic/deprecation.rb:5
Formtastic::Deprecation = T.let(T.unsafe(nil), ActiveSupport::Deprecation)

# pkg:gem/formtastic#lib/formtastic/form_builder.rb:3
class Formtastic::FormBuilder < ::ActionView::Helpers::FormBuilder
  ...
  # pkg:gem/formtastic#lib/formtastic/form_builder.rb:98
  def initialize(object_name, object, template, options); end

  # pkg:gem/formtastic#lib/formtastic/form_builder.rb:15
  ...
  # pkg:gem/formtastic#lib/formtastic/form_builder.rb:56
  def auto_index; end
  ...
  # pkg:gem/formtastic#lib/formtastic/form_builder.rb:15
  def semantic_errors_link_to_inputs; end

  # pkg:gem/formtastic#lib/formtastic/form_builder.rb:15
  def semantic_errors_link_to_inputs=(_arg0); end
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/form_builder.rb:94
  ...
  # pkg:gem/formtastic#lib/formtastic/form_builder.rb:54
  def template; end
  ...
  class << self
    ...
    #   @api public
    #
    # pkg:gem/formtastic#lib/formtastic/form_builder.rb:14
    ...
    # pkg:gem/formtastic#lib/formtastic/form_builder.rb:15
    def semantic_errors_link_to_inputs=(value); end
    ...
    # pkg:gem/formtastic#lib/formtastic/form_builder.rb:15
    def __class_attr_semantic_errors_link_to_inputs; end

    # pkg:gem/formtastic#lib/formtastic/form_builder.rb:15
    def __class_attr_semantic_errors_link_to_inputs=(new_value); end
...
# pkg:gem/formtastic#lib/formtastic/helpers.rb:3
module Formtastic::Helpers; end

# pkg:gem/formtastic#lib/formtastic/helpers/action_helper.rb:4
module Formtastic::Helpers::ActionHelper
  ...
  # @todo document i18n keys
  #
  # pkg:gem/formtastic#lib/formtastic/helpers/action_helper.rb:78
  def action(method, options = T.unsafe(nil)); end

  protected

  # pkg:gem/formtastic#lib/formtastic/helpers/action_helper.rb:89
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/helpers/action_helper.rb:107
...
#
# pkg:gem/formtastic#lib/formtastic/helpers/actions_helper.rb:54
module Formtastic::Helpers::ActionsHelper
  ...
  # @todo document i18n keys
  #
  # pkg:gem/formtastic#lib/formtastic/helpers/actions_helper.rb:148
  def actions(*args, &block); end

  protected

  # pkg:gem/formtastic#lib/formtastic/helpers/actions_helper.rb:163
  def default_actions; end
end

# @private
#
# pkg:gem/formtastic#lib/formtastic/helpers/enum.rb:5
module Formtastic::Helpers::Enum
  # Returns the enum (if defined) for the given method
  #
  # pkg:gem/formtastic#lib/formtastic/helpers/enum.rb:7
  def enum_for(method); end
end

# pkg:gem/formtastic#lib/formtastic/helpers/errors_helper.rb:4
module Formtastic::Helpers::ErrorsHelper
  ...
  #   <% end %>
  #
  # pkg:gem/formtastic#lib/formtastic/helpers/errors_helper.rb:46
  def semantic_errors(*args); end

  protected

  # pkg:gem/formtastic#lib/formtastic/helpers/errors_helper.rb:79
  def error_keys(method, options); end

  # Returns "Attribute error_message_sentence" localized, humanized
  #
  # pkg:gem/formtastic#lib/formtastic/helpers/errors_helper.rb:128
  def error_message_for_attribute(attribute); end

  # pkg:gem/formtastic#lib/formtastic/helpers/errors_helper.rb:89
  def has_errors?(method, options); end

  # pkg:gem/formtastic#lib/formtastic/helpers/errors_helper.rb:94
  def render_inline_errors?; end

  # returns { 'attribute': 'error_message_for_attribute' }
  #
  # pkg:gem/formtastic#lib/formtastic/helpers/errors_helper.rb:113
  def semantic_error_hash_from_attributes(*args); end

  # pkg:gem/formtastic#lib/formtastic/helpers/errors_helper.rb:98
  def semantic_error_list_from_attributes(*args); end
end

# pkg:gem/formtastic#lib/formtastic/helpers/errors_helper.rb:9
Formtastic::Helpers::ErrorsHelper::INLINE_ERROR_TYPES = T.let(T.unsafe(nil), Array)

# @private
#
# pkg:gem/formtastic#lib/formtastic/helpers/fieldset_wrapper.rb:5
module Formtastic::Helpers::FieldsetWrapper
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/helpers/fieldset_wrapper.rb:25
  def field_set_and_list_wrapping(*args, &block); end

  # pkg:gem/formtastic#lib/formtastic/helpers/fieldset_wrapper.rb:52
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/helpers/fieldset_wrapper.rb:62
  def parent_child_index(parent); end
end

# @private
#
# pkg:gem/formtastic#lib/formtastic/helpers/file_column_detection.rb:5
module Formtastic::Helpers::FileColumnDetection
  # pkg:gem/formtastic#lib/formtastic/helpers/file_column_detection.rb:7
...
#
# pkg:gem/formtastic#lib/formtastic/helpers/form_helper.rb:50
module Formtastic::Helpers::FormHelper
  # pkg:gem/formtastic#lib/formtastic/helpers/form_helper.rb:55
  def builder; end

  # pkg:gem/formtastic#lib/formtastic/helpers/form_helper.rb:55
  def builder=(val); end

  # pkg:gem/formtastic#lib/formtastic/helpers/form_helper.rb:60
  def default_form_class; end

  # pkg:gem/formtastic#lib/formtastic/helpers/form_helper.rb:60
  def default_form_class=(val); end

  # pkg:gem/formtastic#lib/formtastic/helpers/form_helper.rb:65
  def default_form_model_class_proc; end

  # pkg:gem/formtastic#lib/formtastic/helpers/form_helper.rb:65
  def default_form_model_class_proc=(val); end

  # pkg:gem/formtastic#lib/formtastic/helpers/form_helper.rb:71
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/helpers/form_helper.rb:183
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/helpers/form_helper.rb:154
  def semantic_form_for(record_or_name_or_array, *args, &proc); end

  protected

  # pkg:gem/formtastic#lib/formtastic/helpers/form_helper.rb:195
...
#
# pkg:gem/formtastic#lib/formtastic/helpers/input_helper.rb:38
module Formtastic::Helpers::InputHelper
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/helpers/input_helper.rb:235
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/helpers/input_helper.rb:309
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/helpers/input_helper.rb:257
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/helpers/input_helper.rb:341
...
#
# pkg:gem/formtastic#lib/formtastic/helpers/inputs_helper.rb:47
module Formtastic::Helpers::InputsHelper
  ...
  #   <% end %>
  #
  # pkg:gem/formtastic#lib/formtastic/helpers/inputs_helper.rb:280
  ...
  # generated input.
  #
  # pkg:gem/formtastic#lib/formtastic/helpers/inputs_helper.rb:338
  def association_columns(*by_associations); end

  # Collects content columns (non-relation columns) for the current form object class.
  #
  # pkg:gem/formtastic#lib/formtastic/helpers/inputs_helper.rb:364
  def content_columns; end

  # pkg:gem/formtastic#lib/formtastic/helpers/inputs_helper.rb:311
  def default_columns_for_object; end

  # pkg:gem/formtastic#lib/formtastic/helpers/inputs_helper.rb:405
  def field_set_title_from_args(*args); end

  # pkg:gem/formtastic#lib/formtastic/helpers/inputs_helper.rb:318
  def fieldset_contents_from_column_list(columns); end

  # Collects all foreign key columns
  #
  # pkg:gem/formtastic#lib/formtastic/helpers/inputs_helper.rb:355
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/helpers/inputs_helper.rb:376
  def inputs_for_nested_attributes(*args, &block); end
end

# @private
#
# pkg:gem/formtastic#lib/formtastic/helpers/reflection.rb:5
module Formtastic::Helpers::Reflection
  # pkg:gem/formtastic#lib/formtastic/helpers/reflection.rb:16
  def association_macro_for_method(method); end

  # pkg:gem/formtastic#lib/formtastic/helpers/reflection.rb:21
  def association_primary_key_for_method(method); end

  # If an association method is passed in (f.input :author) try to find the
  # reflection object.
  #
  # pkg:gem/formtastic#lib/formtastic/helpers/reflection.rb:8
  def reflection_for(method); end
end

# @private
#
# pkg:gem/formtastic#lib/formtastic/html_attributes.rb:4
module Formtastic::HtmlAttributes
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/html_attributes.rb:6
  def dom_id_namespace; end

  protected

  # pkg:gem/formtastic#lib/formtastic/html_attributes.rb:19
  def humanized_attribute_name(method); end
end

# @private
#
# pkg:gem/formtastic#lib/formtastic/i18n.rb:5
module Formtastic::I18n
  class << self
    # pkg:gem/formtastic#lib/formtastic/i18n.rb:28
    def t(*args); end

    # pkg:gem/formtastic#lib/formtastic/i18n.rb:21
    def translate(*args); end
  end
end

# pkg:gem/formtastic#lib/formtastic/i18n.rb:7
Formtastic::I18n::DEFAULT_SCOPE = T.let(T.unsafe(nil), Array)

# pkg:gem/formtastic#lib/formtastic/i18n.rb:8
Formtastic::I18n::DEFAULT_VALUES = T.let(T.unsafe(nil), Hash)

# pkg:gem/formtastic#lib/formtastic/i18n.rb:9
...
#
# pkg:gem/formtastic#lib/formtastic/input_class_finder.rb:8
class Formtastic::InputClassFinder < ::Formtastic::NamespacedClassFinder
  # @param builder [FormBuilder]
  #
  # pkg:gem/formtastic#lib/formtastic/input_class_finder.rb:11
  def initialize(builder); end

  # pkg:gem/formtastic#lib/formtastic/input_class_finder.rb:15
  def class_name(as); end
end

# pkg:gem/formtastic#lib/formtastic/inputs.rb:3
module Formtastic::Inputs
  extend ::ActiveSupport::Autoload
end

# pkg:gem/formtastic#lib/formtastic/inputs/base.rb:4
module Formtastic::Inputs::Base
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/base.rb:8
  def initialize(builder, template, object, object_name, method, options); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base.rb:6
  def builder; end
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/inputs/base.rb:38
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/inputs/base.rb:23
  def warn_and_correct_option!(old_option_name, new_option_name); end

  # Useful for deprecating options.
  #
  # pkg:gem/formtastic#lib/formtastic/inputs/base.rb:31
  def warn_deprecated_option!(old_option_name, instructions); end
end

# pkg:gem/formtastic#lib/formtastic/inputs/base/aria.rb:5
module Formtastic::Inputs::Base::Aria
  # pkg:gem/formtastic#lib/formtastic/inputs/base/aria.rb:17
  def describedby; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/aria.rb:7
  def error_aria_attributes; end
end

# pkg:gem/formtastic#lib/formtastic/inputs/base/associations.rb:5
module Formtastic::Inputs::Base::Associations
  include ::Formtastic::Helpers::Reflection

  # :belongs_to, etc
  #
  # pkg:gem/formtastic#lib/formtastic/inputs/base/associations.rb:9
  def association; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/associations.rb:25
  def association_primary_key; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/associations.rb:17
  def belongs_to?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/associations.rb:21
  def has_many?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/associations.rb:13
  def reflection; end
end

# pkg:gem/formtastic#lib/formtastic/inputs/base/choices.rb:5
module Formtastic::Inputs::Base::Choices
  # pkg:gem/formtastic#lib/formtastic/inputs/base/choices.rb:43
  def choice_html(choice); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/choices.rb:59
  def choice_html_options(choice); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/choices.rb:71
  def choice_html_safe_value(choice); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/choices.rb:75
  def choice_input_dom_id(choice); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/choices.rb:47
  def choice_label(choice); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/choices.rb:55
  def choice_value(choice); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/choices.rb:29
  def choice_wrapping(html_options, &block); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/choices.rb:36
  def choice_wrapping_html_options(choice); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/choices.rb:18
  def choices_group_wrapping(&block); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/choices.rb:25
  def choices_group_wrapping_html_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/choices.rb:7
  def choices_wrapping(&block); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/choices.rb:14
  def choices_wrapping_html_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/choices.rb:67
  def custom_choice_html_options(choice); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/choices.rb:63
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/inputs/base/choices.rb:102
  def label_html_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/choices.rb:89
  def legend_html; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/choices.rb:85
  def value_as_class?; end
end

# pkg:gem/formtastic#lib/formtastic/inputs/base/collections.rb:5
module Formtastic::Inputs::Base::Collections
  # pkg:gem/formtastic#lib/formtastic/inputs/base/collections.rb:50
  def collection; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/collections.rb:131
  def collection_for_boolean; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/collections.rb:74
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/inputs/base/collections.rb:114
  def collection_from_enum; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/collections.rb:127
  def collection_from_enum?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/collections.rb:62
  def collection_from_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/collections.rb:23
  def label_and_value_method; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/collections.rb:27
  def label_and_value_method_from_collection(_collection); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/collections.rb:7
  def label_method; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/collections.rb:11
  def label_method_from_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/collections.rb:46
  def raw_collection; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/collections.rb:140
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/inputs/base/collections.rb:150
  def send_or_call_or_object(duck, object); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/collections.rb:15
  def value_method; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/collections.rb:19
  def value_method_from_options; end
end

# pkg:gem/formtastic#lib/formtastic/inputs/base/database.rb:5
module Formtastic::Inputs::Base::Database
  # pkg:gem/formtastic#lib/formtastic/inputs/base/database.rb:7
  def column; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/database.rb:13
  def column?; end
end

# pkg:gem/formtastic#lib/formtastic/inputs/base/datetime_pickerish.rb:5
module Formtastic::Inputs::Base::DatetimePickerish
  include ::Formtastic::Inputs::Base::Placeholder

  # pkg:gem/formtastic#lib/formtastic/inputs/base/datetime_pickerish.rb:52
  def default_maxlength; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/datetime_pickerish.rb:12
  def default_size; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/datetime_pickerish.rb:56
  def default_step; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/datetime_pickerish.rb:24
  def extra_input_html_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/datetime_pickerish.rb:8
  def html_input_type; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/datetime_pickerish.rb:20
  def input_html_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/datetime_pickerish.rb:46
  def maxlength; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/datetime_pickerish.rb:34
  def size; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/datetime_pickerish.rb:40
  def step; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/datetime_pickerish.rb:16
  def value; end

  protected

  # pkg:gem/formtastic#lib/formtastic/inputs/base/datetime_pickerish.rb:62
  def step_from_macro(sym); end
end

# pkg:gem/formtastic#lib/formtastic/inputs/base/errors.rb:5
module Formtastic::Inputs::Base::Errors
  # pkg:gem/formtastic#lib/formtastic/inputs/base/errors.rb:25
  def error_first_html; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/errors.rb:7
  def error_html; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/errors.rb:48
  def error_keys; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/errors.rb:16
  def error_list_html; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/errors.rb:30
  def error_none_html; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/errors.rb:11
  def error_sentence_html; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/errors.rb:38
  def errors; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/errors.rb:34
  def errors?; end
end

# pkg:gem/formtastic#lib/formtastic/inputs/base/fileish.rb:5
module Formtastic::Inputs::Base::Fileish
  # pkg:gem/formtastic#lib/formtastic/inputs/base/fileish.rb:7
  def file?; end
end

# pkg:gem/formtastic#lib/formtastic/inputs/base/hints.rb:5
module Formtastic::Inputs::Base::Hints
  # pkg:gem/formtastic#lib/formtastic/inputs/base/hints.rb:17
  def hint?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/hints.rb:7
  def hint_html; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/hints.rb:21
  def hint_text; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/hints.rb:25
  def hint_text_from_options; end
end

# pkg:gem/formtastic#lib/formtastic/inputs/base/html.rb:5
module Formtastic::Inputs::Base::Html
  # pkg:gem/formtastic#lib/formtastic/inputs/base/html.rb:31
  def dom_id; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/html.rb:40
  def dom_index; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/html.rb:22
  def input_html_options; end
  ...
  #     end
  #
  # pkg:gem/formtastic#lib/formtastic/inputs/base/html.rb:18
  def to_html; end
end

# pkg:gem/formtastic#lib/formtastic/inputs/base/labelling.rb:5
module Formtastic::Inputs::Base::Labelling
  include ::Formtastic::LocalizedString

  # pkg:gem/formtastic#lib/formtastic/inputs/base/labelling.rb:37
  def label_from_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/labelling.rb:9
  def label_html; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/labelling.rb:13
  def label_html_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/labelling.rb:20
  def label_text; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/labelling.rb:41
  def localized_label; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/labelling.rb:45
  def render_label?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/labelling.rb:29
  def requirement_text; end

  # TODO: why does this need to be memoized in order to make the inputs_spec tests pass?
  #
  # pkg:gem/formtastic#lib/formtastic/inputs/base/labelling.rb:25
  def requirement_text_or_proc; end
end

# pkg:gem/formtastic#lib/formtastic/inputs/base/naming.rb:5
module Formtastic::Inputs::Base::Naming
  # pkg:gem/formtastic#lib/formtastic/inputs/base/naming.rb:7
  def as; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/naming.rb:19
  def attributized_method_name; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/naming.rb:23
  def humanized_method_name; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/naming.rb:36
  def input_name; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/naming.rb:15
  def sanitized_method_name; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/naming.rb:11
  def sanitized_object_name; end
end

# pkg:gem/formtastic#lib/formtastic/inputs/base/numeric.rb:5
module Formtastic::Inputs::Base::Numeric
  # pkg:gem/formtastic#lib/formtastic/inputs/base/numeric.rb:39
  def in_option; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/numeric.rb:6
  def input_html_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/numeric.rb:34
  def max_option; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/numeric.rb:29
  def min_option; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/numeric.rb:24
  def step_option; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/numeric.rb:43
  def wrapper_html_options; end
end

# pkg:gem/formtastic#lib/formtastic/inputs/base/options.rb:5
module Formtastic::Inputs::Base::Options
  # pkg:gem/formtastic#lib/formtastic/inputs/base/options.rb:11
  def formtastic_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/options.rb:7
  def input_options; end
end

# pkg:gem/formtastic#lib/formtastic/inputs/base/placeholder.rb:5
module Formtastic::Inputs::Base::Placeholder
  # pkg:gem/formtastic#lib/formtastic/inputs/base/placeholder.rb:7
  def input_html_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/placeholder.rb:11
  def placeholder_text; end
end

# pkg:gem/formtastic#lib/formtastic/inputs/base/stringish.rb:5
module Formtastic::Inputs::Base::Stringish
  # Overrides standard `input_html_options` to provide a `maxlength` and `size` attribute.
  #
  # pkg:gem/formtastic#lib/formtastic/inputs/base/stringish.rb:16
  def input_html_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/stringish.rb:27
  def maxlength; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/stringish.rb:23
  def size; end

  # @abstract Override this method in your input class to describe how the input should render itself.
  #
  # pkg:gem/formtastic#lib/formtastic/inputs/base/stringish.rb:8
  def to_html; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/stringish.rb:31
  def wrapper_html_options; end
end
...
#
# pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:95
module Formtastic::Inputs::Base::Timeish
  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:123
  def date_fragments; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:127
  def default_date_fragments; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:150
  def fragment_id(fragment); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:168
  def fragment_input_html(fragment); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:139
  def fragment_label(fragment); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:158
  def fragment_label_html(fragment); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:154
  def fragment_name(fragment); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:173
  def fragment_prefix; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:131
  def fragment_wrapping(&block); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:135
  def fragment_wrapping_html_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:115
  def fragments; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:225
  def fragments_inner_wrapping(&block); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:214
  def fragments_label; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:203
  def fragments_wrapping(&block); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:210
  def fragments_wrapping_html_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:235
  def hidden_field_name(fragment); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:231
  def hidden_fragments; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:194
  def i18n_date_fragments; end

  # TODO extract to BlankOptions or similar -- Select uses similar code
  #
  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:182
  def include_blank?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:190
  def position(fragment); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:186
  def positions; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:119
  def time_fragments; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:97
  def to_html; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/timeish.rb:163
  def value; end
end

# pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:5
module Formtastic::Inputs::Base::Validations
  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:180
  def autofocus?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:186
  def column_limit; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:205
  def limit; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:168
  def not_required_through_negated_validation!; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:164
  def not_required_through_negated_validation?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:176
  def optional?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:209
  def readonly?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:213
  def readonly_attribute?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:221
  def readonly_from_options?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:132
  def required?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:160
  def required_attribute?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:172
  def responds_to_global_required?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:117
  def validation_integer_only?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:55
  def validation_limit; end

  # Prefer :less_than_or_equal_to over :less_than, for no particular reason.
  #
  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:88
  def validation_max; end

  # Prefer :greater_than_or_equal_to over :greater_than, for no particular reason.
  #
  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:68
  def validation_min; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:106
  def validation_step; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:25
  def validations; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:128
  def validations?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:35
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:229
  def option_value(option, object); end
end

# pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:16
class Formtastic::Inputs::Base::Validations::IndeterminableMaximumAttributeError < ::ArgumentError
  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:17
  def message; end
end

# pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:7
class Formtastic::Inputs::Base::Validations::IndeterminableMinimumAttributeError < ::ArgumentError
  # pkg:gem/formtastic#lib/formtastic/inputs/base/validations.rb:8
  def message; end
end

# @todo relies on `dom_id`, `required?`, `optional`, `errors?`, `association_primary_key` & `sanitized_method_name` methods from another module
#
# pkg:gem/formtastic#lib/formtastic/inputs/base/wrapping.rb:6
module Formtastic::Inputs::Base::Wrapping
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/inputs/base/wrapping.rb:10
  def input_wrapping(&block); end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/wrapping.rb:32
  def wrapper_classes; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/wrapping.rb:28
  def wrapper_classes_raw; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/wrapping.rb:44
  def wrapper_dom_id; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/wrapping.rb:17
  def wrapper_html_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/base/wrapping.rb:24
...
#
# pkg:gem/formtastic#lib/formtastic/inputs/boolean_input.rb:33
class Formtastic::Inputs::BooleanInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/boolean_input.rb:66
  def check_box_html; end

  # pkg:gem/formtastic#lib/formtastic/inputs/boolean_input.rb:94
  def checked?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/boolean_input.rb:74
  def checked_value; end

  # pkg:gem/formtastic#lib/formtastic/inputs/boolean_input.rb:43
  def hidden_field_html; end

  # pkg:gem/formtastic#lib/formtastic/inputs/boolean_input.rb:82
  def input_html_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/boolean_input.rb:86
  def input_html_options_name; end

  # pkg:gem/formtastic#lib/formtastic/inputs/boolean_input.rb:55
  def label_html_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/boolean_input.rb:62
  def label_text_with_embedded_checkbox; end

  # pkg:gem/formtastic#lib/formtastic/inputs/boolean_input.rb:47
  def label_with_nested_checkbox; end

  # pkg:gem/formtastic#lib/formtastic/inputs/boolean_input.rb:78
  def responds_to_global_required?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/boolean_input.rb:36
  def to_html; end

  # pkg:gem/formtastic#lib/formtastic/inputs/boolean_input.rb:70
  def unchecked_value; end

  private

  # pkg:gem/formtastic#lib/formtastic/inputs/boolean_input.rb:100
...
#
# pkg:gem/formtastic#lib/formtastic/inputs/check_boxes_input.rb:68
class Formtastic::Inputs::CheckBoxesInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/check_boxes_input.rb:73
  def initialize(*args); end

  # pkg:gem/formtastic#lib/formtastic/inputs/check_boxes_input.rb:117
  def check_box_with_hidden_input(choice); end

  # pkg:gem/formtastic#lib/formtastic/inputs/check_boxes_input.rb:127
  def check_box_without_hidden_input(choice); end

  # pkg:gem/formtastic#lib/formtastic/inputs/check_boxes_input.rb:141
  def checked?(value); end

  # pkg:gem/formtastic#lib/formtastic/inputs/check_boxes_input.rb:94
  def choice_html(choice); end

  # pkg:gem/formtastic#lib/formtastic/inputs/check_boxes_input.rb:145
  def disabled?(value); end

  # pkg:gem/formtastic#lib/formtastic/inputs/check_boxes_input.rb:153
  def disabled_values; end

  # pkg:gem/formtastic#lib/formtastic/inputs/check_boxes_input.rb:137
  def extra_html_options(choice); end

  # pkg:gem/formtastic#lib/formtastic/inputs/check_boxes_input.rb:102
  def hidden_field_for_all; end

  # pkg:gem/formtastic#lib/formtastic/inputs/check_boxes_input.rb:113
  def hidden_fields_for_every?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/check_boxes_input.rb:163
  def input_name; end

  # pkg:gem/formtastic#lib/formtastic/inputs/check_boxes_input.rb:149
  def selected_values; end

  # pkg:gem/formtastic#lib/formtastic/inputs/check_boxes_input.rb:78
  def to_html; end

  # pkg:gem/formtastic#lib/formtastic/inputs/check_boxes_input.rb:159
  def unchecked_value; end

  protected

  # pkg:gem/formtastic#lib/formtastic/inputs/check_boxes_input.rb:173
  def checkbox_input(choice); end

  # pkg:gem/formtastic#lib/formtastic/inputs/check_boxes_input.rb:181
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# pkg:gem/formtastic#lib/formtastic/inputs/color_input.rb:29
class Formtastic::Inputs::ColorInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/color_input.rb:34
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# pkg:gem/formtastic#lib/formtastic/inputs/country_input.rb:65
class Formtastic::Inputs::CountryInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/country_input.rb:78
  def input_options_including_priorities; end

  # pkg:gem/formtastic#lib/formtastic/inputs/country_input.rb:84
  def priority_countries; end

  # pkg:gem/formtastic#lib/formtastic/inputs/country_input.rb:70
  def to_html; end
end

# pkg:gem/formtastic#lib/formtastic/inputs/country_input.rb:68
...
#
# pkg:gem/formtastic#lib/formtastic/inputs/datalist_input.rb:14
class Formtastic::Inputs::DatalistInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/datalist_input.rb:36
  def data_list_html; end

  # pkg:gem/formtastic#lib/formtastic/inputs/datalist_input.rb:32
  def html_id_of_datalist; end

  # pkg:gem/formtastic#lib/formtastic/inputs/datalist_input.rb:28
  def input_html_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/datalist_input.rb:19
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# pkg:gem/formtastic#lib/formtastic/inputs/date_picker_input.rb:71
class Formtastic::Inputs::DatePickerInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/date_picker_input.rb:80
  def default_size; end

  # pkg:gem/formtastic#lib/formtastic/inputs/date_picker_input.rb:76
  def html_input_type; end

  # pkg:gem/formtastic#lib/formtastic/inputs/date_picker_input.rb:84
  def value; end
end
...
#
# pkg:gem/formtastic#lib/formtastic/inputs/date_select_input.rb:7
class Formtastic::Inputs::DateSelectInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/date_select_input.rb:26
  def fragment_value(fragment); end

  # pkg:gem/formtastic#lib/formtastic/inputs/date_select_input.rb:16
  def hidden_date_fragments; end

  # pkg:gem/formtastic#lib/formtastic/inputs/date_select_input.rb:20
  def hidden_fragments; end

  # We don't want hour and minute fragments on a date input
  #
  # pkg:gem/formtastic#lib/formtastic/inputs/date_select_input.rb:12
  def time_fragments; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# pkg:gem/formtastic#lib/formtastic/inputs/datetime_picker_input.rb:79
class Formtastic::Inputs::DatetimePickerInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/datetime_picker_input.rb:89
  def default_size; end

  # pkg:gem/formtastic#lib/formtastic/inputs/datetime_picker_input.rb:84
  def html_input_type; end

  # pkg:gem/formtastic#lib/formtastic/inputs/datetime_picker_input.rb:93
  def value; end
end
...
# @see Formtastic::Inputs::Base::Timeish Timeish module for documentation of date, time and datetime input options.
#
# pkg:gem/formtastic#lib/formtastic/inputs/datetime_select_input.rb:8
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# pkg:gem/formtastic#lib/formtastic/inputs/email_input.rb:29
class Formtastic::Inputs::EmailInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/email_input.rb:34
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# pkg:gem/formtastic#lib/formtastic/inputs/file_input.rb:33
class Formtastic::Inputs::FileInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/file_input.rb:35
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# pkg:gem/formtastic#lib/formtastic/inputs/hidden_input.rb:32
class Formtastic::Inputs::HiddenInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/hidden_input.rb:45
  def error_html; end

  # pkg:gem/formtastic#lib/formtastic/inputs/hidden_input.rb:49
  def errors?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/hidden_input.rb:57
  def hint?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/hidden_input.rb:53
  def hint_html; end

  # pkg:gem/formtastic#lib/formtastic/inputs/hidden_input.rb:35
  def input_html_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/hidden_input.rb:39
  def to_html; end
end
...
#
# pkg:gem/formtastic#lib/formtastic/inputs/number_input.rb:71
class Formtastic::Inputs::NumberInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/number_input.rb:83
  def step_option; end

  # pkg:gem/formtastic#lib/formtastic/inputs/number_input.rb:76
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# pkg:gem/formtastic#lib/formtastic/inputs/password_input.rb:29
class Formtastic::Inputs::PasswordInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/password_input.rb:34
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# pkg:gem/formtastic#lib/formtastic/inputs/phone_input.rb:29
class Formtastic::Inputs::PhoneInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/phone_input.rb:34
  def to_html; end
end
...
#
# pkg:gem/formtastic#lib/formtastic/inputs/radio_input.rb:128
class Formtastic::Inputs::RadioInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/radio_input.rb:148
  def choice_html(choice); end

  # Override to remove the for attribute since this isn't associated with any element, as it's
  # nested inside the legend.
  #
  # pkg:gem/formtastic#lib/formtastic/inputs/radio_input.rb:158
  def label_html_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/radio_input.rb:133
  def to_html; end
end
...
# @see https://api.rubyonrails.org/classes/ActiveModel/Validations/HelperMethods.html#method-i-validates_numericality_of Rails' Numericality validation documentation
#
# pkg:gem/formtastic#lib/formtastic/inputs/range_input.rb:71
class Formtastic::Inputs::RangeInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/range_input.rb:86
  def max_option; end

  # pkg:gem/formtastic#lib/formtastic/inputs/range_input.rb:82
  def min_option; end

  # pkg:gem/formtastic#lib/formtastic/inputs/range_input.rb:90
  def step_option; end

  # pkg:gem/formtastic#lib/formtastic/inputs/range_input.rb:75
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# pkg:gem/formtastic#lib/formtastic/inputs/search_input.rb:28
class Formtastic::Inputs::SearchInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/search_input.rb:33
  def to_html; end
end
...
# @todo Do/can we support the per-item HTML options like RadioInput?
#
# pkg:gem/formtastic#lib/formtastic/inputs/select_input.rb:157
class Formtastic::Inputs::SelectInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/select_input.rb:161
  def initialize(*args); end

  # pkg:gem/formtastic#lib/formtastic/inputs/select_input.rb:197
  def extra_input_html_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/select_input.rb:177
  def include_blank; end

  # pkg:gem/formtastic#lib/formtastic/inputs/select_input.rb:193
  def input_html_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/select_input.rb:206
  def input_html_options_name; end

  # pkg:gem/formtastic#lib/formtastic/inputs/select_input.rb:214
  def input_html_options_name_multiple; end

  # pkg:gem/formtastic#lib/formtastic/inputs/select_input.rb:189
  def input_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/select_input.rb:185
  def label_html_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/select_input.rb:226
  def multiple?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/select_input.rb:218
  def multiple_by_association?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/select_input.rb:222
  def multiple_by_options?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/select_input.rb:181
  def prompt?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/select_input.rb:173
  def select_html; end

  # pkg:gem/formtastic#lib/formtastic/inputs/select_input.rb:230
  def single?; end

  # pkg:gem/formtastic#lib/formtastic/inputs/select_input.rb:166
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# pkg:gem/formtastic#lib/formtastic/inputs/string_input.rb:30
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# pkg:gem/formtastic#lib/formtastic/inputs/text_input.rb:29
class Formtastic::Inputs::TextInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/text_input.rb:33
  def input_html_options; end

  # pkg:gem/formtastic#lib/formtastic/inputs/text_input.rb:40
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# pkg:gem/formtastic#lib/formtastic/inputs/time_picker_input.rb:72
class Formtastic::Inputs::TimePickerInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/time_picker_input.rb:81
  def default_size; end

  # pkg:gem/formtastic#lib/formtastic/inputs/time_picker_input.rb:94
  def default_step; end

  # pkg:gem/formtastic#lib/formtastic/inputs/time_picker_input.rb:77
  def html_input_type; end

  # pkg:gem/formtastic#lib/formtastic/inputs/time_picker_input.rb:85
  def value; end
end
...
# @see Formtastic::Inputs::Base::Timeish Timeish module for documentation of date, time and datetime input options.
#
# pkg:gem/formtastic#lib/formtastic/inputs/time_select_input.rb:10
class Formtastic::Inputs::TimeSelectInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/time_select_input.rb:23
  def fragment_value(fragment); end

  # we don't want year / month / day fragments if :ignore_date => true
  #
  # pkg:gem/formtastic#lib/formtastic/inputs/time_select_input.rb:15
  def fragments; end

  # pkg:gem/formtastic#lib/formtastic/inputs/time_select_input.rb:27
  def hidden_fragments; end

  # pkg:gem/formtastic#lib/formtastic/inputs/time_select_input.rb:19
...
#
# pkg:gem/formtastic#lib/formtastic/inputs/time_zone_input.rb:44
class Formtastic::Inputs::TimeZoneInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/time_zone_input.rb:54
  def priority_zones; end

  # pkg:gem/formtastic#lib/formtastic/inputs/time_zone_input.rb:47
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# pkg:gem/formtastic#lib/formtastic/inputs/url_input.rb:29
class Formtastic::Inputs::UrlInput
  ...
  # pkg:gem/formtastic#lib/formtastic/inputs/url_input.rb:34
  def to_html; end
end

# pkg:gem/formtastic#lib/formtastic/localized_string.rb:3
module Formtastic::LocalizedString
  # pkg:gem/formtastic#lib/formtastic/localized_string.rb:5
  def model_name; end

  protected

  # pkg:gem/formtastic#lib/formtastic/localized_string.rb:11
...
#
# pkg:gem/formtastic#lib/formtastic/localizer.rb:27
class Formtastic::Localizer
  # pkg:gem/formtastic#lib/formtastic/localizer.rb:56
  def initialize(current_builder); end

  # pkg:gem/formtastic#lib/formtastic/localizer.rb:50
  def builder; end

  # pkg:gem/formtastic#lib/formtastic/localizer.rb:50
  def builder=(_arg0); end

  # pkg:gem/formtastic#lib/formtastic/localizer.rb:60
  def localize(key, value, type, options = T.unsafe(nil)); end

  protected

  # pkg:gem/formtastic#lib/formtastic/localizer.rb:134
  def escape_html_entities(string); end

  # pkg:gem/formtastic#lib/formtastic/localizer.rb:146
  def i18n_cache_lookups; end

  # pkg:gem/formtastic#lib/formtastic/localizer.rb:142
  def i18n_lookups_by_default; end

  # pkg:gem/formtastic#lib/formtastic/localizer.rb:118
  def normalize_model_name(name); end

  class << self
    # pkg:gem/formtastic#lib/formtastic/localizer.rb:52
    def cache; end
  end
end

# pkg:gem/formtastic#lib/formtastic/localizer.rb:28
class Formtastic::Localizer::Cache
  # pkg:gem/formtastic#lib/formtastic/localizer.rb:41
  def cache; end

  # pkg:gem/formtastic#lib/formtastic/localizer.rb:45
  def clear!; end

  # pkg:gem/formtastic#lib/formtastic/localizer.rb:29
  def get(key); end

  # pkg:gem/formtastic#lib/formtastic/localizer.rb:33
  def has_key?(key); end

  # pkg:gem/formtastic#lib/formtastic/localizer.rb:37
...
#
# pkg:gem/formtastic#lib/formtastic/namespaced_class_finder.rb:25
class Formtastic::NamespacedClassFinder
  # @param namespaces [Array<Module>]
  #
  # pkg:gem/formtastic#lib/formtastic/namespaced_class_finder.rb:41
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/namespaced_class_finder.rb:68
  def class_name(as); end
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/namespaced_class_finder.rb:53
  def find(as); end

  # pkg:gem/formtastic#lib/formtastic/namespaced_class_finder.rb:26
  def namespaces; end

  # pkg:gem/formtastic#lib/formtastic/namespaced_class_finder.rb:57
  def resolve(as); end
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/namespaced_class_finder.rb:89
  ...
  #
  # pkg:gem/formtastic#lib/formtastic/namespaced_class_finder.rb:80
  def find_with_const_defined(class_name); end

  # pkg:gem/formtastic#lib/formtastic/namespaced_class_finder.rb:74
  def finder(class_name); end

  class << self
    # pkg:gem/formtastic#lib/formtastic/namespaced_class_finder.rb:36
    def finder_method; end

    # pkg:gem/formtastic#lib/formtastic/namespaced_class_finder.rb:32
