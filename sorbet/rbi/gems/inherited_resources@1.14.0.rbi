...
# pkg:gem/inherited_resources#lib/inherited_resources/engine.rb:1
module InheritedResources
  class << self
    # Change the flash keys used by FlashResponder.
    #
    # pkg:gem/inherited_resources#lib/inherited_resources.rb:23
    def flash_keys=(array); end
  end
end

# pkg:gem/inherited_resources#lib/inherited_resources.rb:9
InheritedResources::ACTIONS = T.let(T.unsafe(nil), Array)

# Holds all default actions for InheritedResouces.
#
# pkg:gem/inherited_resources#lib/inherited_resources/actions.rb:3
module InheritedResources::Actions
  # POST /resources
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/actions.rb:30
  def create(options = T.unsafe(nil), &block); end

  # DELETE /resources/1
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/actions.rb:54
  def destroy(options = T.unsafe(nil), &block); end

  # GET /resources/1/edit
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/actions.rb:24
  def edit(options = T.unsafe(nil), &block); end

  # GET /resources
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/actions.rb:6
  def index(options = T.unsafe(nil), &block); end

  # GET /resources/new
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/actions.rb:18
  def new(options = T.unsafe(nil), &block); end

  # GET /resources/1
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/actions.rb:12
  def show(options = T.unsafe(nil), &block); end

  # PUT /resources/1
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/actions.rb:42
  def update(options = T.unsafe(nil), &block); end

  protected

  # pkg:gem/inherited_resources#lib/inherited_resources/actions.rb:39
  def create!(options = T.unsafe(nil), &block); end

  # pkg:gem/inherited_resources#lib/inherited_resources/actions.rb:61
  def destroy!(options = T.unsafe(nil), &block); end

  # pkg:gem/inherited_resources#lib/inherited_resources/actions.rb:27
  def edit!(options = T.unsafe(nil), &block); end

  # pkg:gem/inherited_resources#lib/inherited_resources/actions.rb:9
  def index!(options = T.unsafe(nil), &block); end

  # pkg:gem/inherited_resources#lib/inherited_resources/actions.rb:21
  def new!(options = T.unsafe(nil), &block); end

  # pkg:gem/inherited_resources#lib/inherited_resources/actions.rb:15
  def show!(options = T.unsafe(nil), &block); end

  # pkg:gem/inherited_resources#lib/inherited_resources/actions.rb:51
  def update!(options = T.unsafe(nil), &block); end
end
...
#
# pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:8
module InheritedResources::BaseHelpers
  ...
  # current resource).
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:128
  ...
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:114
  ...
  # instance variable.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:51
  ...
  #   end
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:22
  def collection; end
  ...
  #   end
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:65
  ...
  #   end
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:88
  ...
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:121
  def parent?; end
  ...
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:43
  def resource; end
  ...
  #   end
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:77
  ...
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:281
  def apply_scopes_if_available(target_object); end

  # getting role for mass-asignment
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:372
  def as_role; end

  # extract attributes from params
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:354
  ...
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:172
  def end_of_association_chain; end

  # Get collection ivar based on the current resource controller.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:232
  def get_collection_ivar; end

  # Get resource ivar based on the current resource controller.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:216
  ...
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:197
  ...
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:205
  def method_for_association_chain; end

  # Returns the appropriated method to build the resource.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:190
  def method_for_build; end

  # Returns finder method for instantiate resource by params[:id]
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:210
  ...
  #    end
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:341
  def permitted_params; end

  # Fast accessor to resource_collection_name
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:156
  def resource_collection_name; end

  # Fast accessor to resource_instance_name
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:162
  def resource_instance_name; end

  # memoize the extraction of attributes from params
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:314
  def resource_params; end

  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:318
  def resource_params_method_name; end

  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:166
  ...
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:257
  def respond_with_dual_blocks(object, options, &block); end

  # checking if role given
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:367
  def role_given?; end

  # Set collection ivar based on the current resource controller.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:242
  def set_collection_ivar(collection); end

  # Set resource ivar based on the current resource controller.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:226
  def set_resource_ivar(resource); end

  # URL to redirect to when redirect implies collection url.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:302
  def smart_collection_url; end

  # URL to redirect to when redirect implies resource url.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:293
  ...
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:288
  def symbols_for_association_chain; end

  # Adds the given object to association chain.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:150
  def with_chain(object); end

  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:380
  def without_protection; end

  # pkg:gem/inherited_resources#lib/inherited_resources/base_helpers.rb:376
...
#
# pkg:gem/inherited_resources#lib/inherited_resources/belongs_to_helpers.rb:50
module InheritedResources::BelongsToHelpers
  protected

  # pkg:gem/inherited_resources#lib/inherited_resources/belongs_to_helpers.rb:60
  def parent; end

  # Parent is always true when belongs_to is called.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/belongs_to_helpers.rb:56
  def parent?; end

  # pkg:gem/inherited_resources#lib/inherited_resources/belongs_to_helpers.rb:64
  def parent_type; end
  ...
  # association chain.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/belongs_to_helpers.rb:73
  def evaluate_parent(parent_symbol, parent_config, chain = T.unsafe(nil)); end

  # pkg:gem/inherited_resources#lib/inherited_resources/belongs_to_helpers.rb:78
  def get_parent_ivar(instance_name); end

  # pkg:gem/inherited_resources#lib/inherited_resources/belongs_to_helpers.rb:83
  ...
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/belongs_to_helpers.rb:107
  def symbols_for_association_chain; end
end

# An object from BlankSlate simply discards all messages sent to it.
#
# pkg:gem/inherited_resources#lib/inherited_resources/blank_slate.rb:3
class InheritedResources::BlankSlate
  # pkg:gem/inherited_resources#lib/inherited_resources/blank_slate.rb:8
  def method_missing(*args); end
end

# pkg:gem/inherited_resources#lib/inherited_resources/class_methods.rb:2
module InheritedResources::ClassMethods
  ...
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/class_methods.rb:74
  ...
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/class_methods.rb:141
  ...
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/class_methods.rb:268
  ...
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/class_methods.rb:37
  def defaults(options); end

  # pkg:gem/inherited_resources#lib/inherited_resources/class_methods.rb:224
  def nested_belongs_to(*symbols, &block); end

  # A quick method to declare optional belongs to.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/class_methods.rb:244
  def optional_belongs_to(*symbols, &block); end

  # A quick method to declare polymorphic belongs to.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/class_methods.rb:228
  def polymorphic_belongs_to(*symbols, &block); end

  # A quick method to declare singleton belongs to.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/class_methods.rb:236
  ...
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/class_methods.rb:286
  def with_role(role); end

  # pkg:gem/inherited_resources#lib/inherited_resources/class_methods.rb:290
  def without_protection(flag); end

  private

  # pkg:gem/inherited_resources#lib/inherited_resources/class_methods.rb:304
  def acts_as_polymorphic!; end

  # pkg:gem/inherited_resources#lib/inherited_resources/class_methods.rb:311
  def acts_as_shallow!; end

  # pkg:gem/inherited_resources#lib/inherited_resources/class_methods.rb:296
  def acts_as_singleton!; end

  # pkg:gem/inherited_resources#lib/inherited_resources/class_methods.rb:395
  def create_custom_action(resource_or_collection, action); end

  # Hook called on inheritance.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/class_methods.rb:407
  def inherited(base); end

  # Initialize resources class accessors and set their default values.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/class_methods.rb:318
...
#   end
#
# pkg:gem/inherited_resources#lib/inherited_resources/dsl.rb:10
module InheritedResources::DSL
  class << self
    # pkg:gem/inherited_resources#lib/inherited_resources/dsl.rb:11
...
#
# pkg:gem/inherited_resources#lib/inherited_resources/polymorphic_helpers.rb:97
module InheritedResources::PolymorphicHelpers
  ...
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/polymorphic_helpers.rb:121
  def parent; end

  # If the polymorphic association is optional, we might not have a parent.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/polymorphic_helpers.rb:130
  def parent?; end

  # pkg:gem/inherited_resources#lib/inherited_resources/polymorphic_helpers.rb:114
  def parent_class; end

  # Returns the parent type. A Comments class can have :task, :file, :note
  # as parent types.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/polymorphic_helpers.rb:104
  def parent_type; end
  ...
  # params are missing.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/polymorphic_helpers.rb:148
  def symbols_for_association_chain; end
end

# pkg:gem/inherited_resources#lib/inherited_resources/engine.rb:2
class InheritedResources::Railtie < ::Rails::Engine; end

# pkg:gem/inherited_resources#lib/inherited_resources/responder.rb:2
...
#
# pkg:gem/inherited_resources#lib/inherited_resources/shallow_helpers.rb:15
module InheritedResources::ShallowHelpers
  private

  # pkg:gem/inherited_resources#lib/inherited_resources/shallow_helpers.rb:35
  def load_parents(instance, parent_symbols); end

  # pkg:gem/inherited_resources#lib/inherited_resources/shallow_helpers.rb:18
  def symbols_for_association_chain; end
end
...
#
# pkg:gem/inherited_resources#lib/inherited_resources/singleton_helpers.rb:37
module InheritedResources::SingletonHelpers
  protected

  # Singleton methods does not deal with collections.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/singleton_helpers.rb:43
  def collection; end
  ...
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/singleton_helpers.rb:75
  def resource; end
  ...
  # Returns the appropriated method to build the resource.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/singleton_helpers.rb:83
  def method_for_association_build; end

  # Sets the method_for_association_chain to nil. See <tt>resource</tt>
  # above for more information.
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/singleton_helpers.rb:90
  def method_for_association_chain; end
end
...
#
# pkg:gem/inherited_resources#lib/inherited_resources/url_helpers.rb:34
module InheritedResources::UrlHelpers
  ...
  #
  # pkg:gem/inherited_resources#lib/inherited_resources/url_helpers.rb:46
  def create_resources_url_helpers!; end

  # pkg:gem/inherited_resources#lib/inherited_resources/url_helpers.rb:228
  def define_helper_method(prefix, name, suffix, segments); end

  # pkg:gem/inherited_resources#lib/inherited_resources/url_helpers.rb:194
  def define_params_helper(prefix, name, singleton, polymorphic, parent_index, ivars); end

  # pkg:gem/inherited_resources#lib/inherited_resources/url_helpers.rb:169
  def generate_url_and_path_helpers(prefix, name, resource_segments, resource_ivars); end

  # pkg:gem/inherited_resources#lib/inherited_resources/url_helpers.rb:141
  def handle_shallow_resource(prefix, name, segments, ivars); end
end

# pkg:gem/inherited_resources#lib/inherited_resources/version.rb:2
