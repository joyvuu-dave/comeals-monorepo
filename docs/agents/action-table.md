...
1. Admin resident form: rename, retire, change multiplier, move unit —
   each as a form submission, with the settled snapshot and the caches
   checked afterward.
2. Admin reservation update and delete, and the overlap refusal
   rendering as an error.
3. Admin unit rename as a form submission.
4. Dinner start time change: calendar and iCal show the new time.
5. Time zone change: what "today" does on the day it changes.
6. Broadcast email flag as a form submission.
