...
1. Admin reservation update and delete, and the overlap refusal
   rendering as an error.
2. Admin unit rename as a form submission.
3. Dinner start time change: calendar and iCal show the new time.
4. Time zone change: what "today" does on the day it changes.
5. Broadcast email flag as a form submission.
