...
| Action                                    | API                         | Admin                                                                                                                                                                                                          | Task/job                                                                                         | Browser          |
| ----------------------------------------- | --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ | ---------------- |
| Create a rotation                         | —                           | — (no admin form since #78; rotations come from the nightly task)                                                                                                                                              | `community_create_rotations_spec`; `EnsureRotationsJob` itself only through `recurring_job_spec` | —                |
